...
enum {
    ...
    TRANSACTION_CONCEPT_TRANSFER = 9,
    TRANSACTION_CONCEPT_UPDATE = 10,
    TRANSACTION_CONCEPT_AUTHORIZE = 11,
    TRANSACTION_CONCEPT_REVOKE = 12,
    TRANSACTION_NUANCE_REGISTER = 13,
    TRANSACTION_NUANCE_UNREGISTER = 14,
    TRANSACTION_NUANCE_TRANSFER = 15,
    TRANSACTION_NUANCE_CHECKPOINT = 16,
    TRANSACTION_NUANCE_AUTHORIZE = 17,
    TRANSACTION_NUANCE_REVOKE = 18,
    TRANSACTION_MCP_REGISTER = 19,
    TRANSACTION_MCP_UNREGISTER = 20,
    TRANSACTION_MCP_TRANSFER = 21,
    TRANSACTION_MCP_AUTHORIZE = 22,
    TRANSACTION_MCP_REVOKE = 23,
    TRANSACTION_MCP_CHECK = 24
};
